...
|:---|:---|:---|
| **Section A** | Concept Cards | 21 topics covering Text Preprocessing, Feature Engineering, Language Representation, Language Models |
| **Section B** | Comparative Analysis | 5 detailed comparisons with tables |
| **Section C** | Workflow Diagrams | 3 interactive visual pipelines |
| **Section D** | Real-World Applications | 6 applications with concept mapping |
| **Section E** | Research & Industry Insights | 2 research developments, 2 industrial apps, 1 open-source framework |
| **Section F** | Sustainability & Societal Impact | UN SDG alignment (300-500 words) |
| **Section G** | Individual Contribution Matrix | Team member contributions |
| **Section H** | Reflection Notes | Critical learning reflections |
...
- **JavaScript (Vanilla)** — Filtering, tabs, scroll-to-top, intersection observer animations
...
- Transformer-based Representations (BERT, GPT)
